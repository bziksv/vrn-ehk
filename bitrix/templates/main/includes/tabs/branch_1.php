<div class="common_info">
 ...
 <span class="number"> <a href="tel:8-800-755-07-76">8-800-755-07-76</a> </span> <span class="number"> <a href="tel:+7473200-89-81">+7 (473) 200-89-81</a></span>
	</div>
	<div class="email">
 <span class="title">E-mail:</span> <a href="mailto:info@vrn-ehk.ru">
		info@vrn-ehk.ru</a>
	</div>
	<div class="address">
 <span class="title">Адрес:</span>
	...
	<div>
 <br>
 <b>Часы работы:</b> 8:00 - 18:00 (пн-пт), 8:30 - 16:30 (сб), воскресенье - выходной <!--время работы -->
	</div>
	<div class="region_list">
		 Пункт выписки товара г. Воронежа (на витринах представлена только часть нашего ассортимента)
	</div>
	<div class="phone">
		<div class="title" style="display:flex">
			 Контактные телефоны: <span class="number" style="margin-left:24px;"> <a href="tel:+7473200-89-81">+7 (473) 200-89-81 (доб. 181)</a></span>
		</div>
	</div>
	<div class="address" style="margin-left:20px;">
 <span class="title">Адрес:</span>
		г. Воронеж, ул. Ильюшина, д. 3
	</div>
	<div class="clear">
	</div>
	<div style="margin-left:60px;">
 <br>
 <b>Часы работы:</b> 8:00 - 18:00 (пн-пт), 13:00 - 14:00 перерыв, суббота, воскресенье - выходной <!--время работы -->
	</div>
</div>
<div class="region_list">
	 Торговый зал г. Воронежа
</div>
...
<tr>
	...
	<td class="e-mail">
 <a href="mailto:kovaleva@vrn-ehk.ru">
		kovaleva@vrn-ehk.ru </a>
	</td>
</tr>
<tr>
	<td class="work">
...
<tr>
	...
	<td class="e-mail">
 <a href="mailto:kovelement@yandex.ru">kovelement@yandex.ru</a><br>
	</td>
</tr>
<tr>
	<td class="work">
	...
	<td class="name">
		 Власиков Александр Николаевич
	</td>
	<td class="e-mail">
 <a href="mailto:m2@vrn-ehk.ru">
		m2@vrn-ehk.ru</a>
	</td>
</tr>
</tbody>
...
Array()
		...
		<h2>Наш склад:</h2>
 <a href="/upload/medialibrary/cde/map_sklad_min.jpg" rel="lightbox[gallery]" class="cur_image"> <img alt="map-sklad.jpg" src="/upload/medialibrary/cde/map_sklad_min.jpg" style="width: 100%; padding: 7px; box-shadow: rgba(0, 0, 0, 0.2) 0px 2px 5px;"> </a>
	</div>
</div>