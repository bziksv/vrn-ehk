		...
		$result = '
			<table border="0" cellspacing="0" cellpadding="0" width="100%" class="adm-detail-content-table edit-table">
				<tbody>
					...
					<tr>
						<td class="adm-detail-content-cell-l">' . Loc::getMessage("AMMINA_SMTP_FIELD_LIMIT_DOMAN_IGNORE") . ':</td>
						<td class="adm-detail-content-cell-r">
							<input type="hidden" name="FIELDS[LIMIT_DOMAN_IGNORE]" value="N"/>
							<input type="checkbox" class="adm-bus-input" name="FIELDS[LIMIT_DOMAN_IGNORE]" id="FIELD_LIMIT_DOMAN_IGNORE" value="Y"' . ($arItem['LIMIT_DOMAN_IGNORE'] === "Y" ? ' checked="checked"' : '') . ' />
						</td>
					</tr>
				</tbody>
			</table>';
