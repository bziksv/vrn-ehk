...
<a target="_blank" title="ПЭК" href="http://www.pecom.ru/ru/services/send/warehouses/voronezh/"> <img width="125" alt="2.jpg" src="http://polimer-vrn.ru/upload/medialibrary/0a8/0a8832f2254fa79b690e4b01d68818d3.jpg" height="40" title="пэк.jpg" hspace="2" border="0" align="left"> </a> <a target="_blank" title="Деловые линии" href="https://www.dellin.ru/"><img width="144" alt="4.jpg" src="http://polimer-vrn.ru/upload/medialibrary/5e7/5e79f7d15c55a1e037f3fee3ce6e1351.jpg" height="30" title="Деловые линии.jpg" hspace="2" border="0" align="left"> </a> <a target="_blank" title="Байкал сервис" href="http://www.baikalsr.ru/"> <img width="195" alt="5.png" src="http://polimer-vrn.ru/upload/medialibrary/38f/38fddbde384ae486954e509d2d20daf9.png" height="25" title="байкал сервис.png" hspace="2" border="0" align="left"> </a> <!--<a target="_blank" title="Желдорэкспедиция" href="http://www.jde.ru/"> <img width="84" alt="6.jpg" src="http://polimer-vrn.ru/upload/medialibrary/942/942bffc3a573a657380a7289dc7a7912.jpg" height="35" title="желдор.jpg" hspace="2" border="0" align="left"> </a>--> <a target="_blank" title="Энергия" href="https://nrg-tk.ru/contacts/russia/voronezh/"> <img width="100" alt="6.jpg" src="/bitrix/templates/main/images/del_logo_1.png" title="желдор.jpg" hspace="2" border="0" align="left"> </a> <a target="_blank" title="ПЭК" href="https://www.cdek.ru/"> <img width="120" alt="logo-sdek.jpg" src="/upload/medialibrary/logo-sdek.jpg" height="26" hspace="2" border="0" align="left"> </a>
 ...
 <b>Внимание:</b> При получении груза в терминале ТК обязательно проверяйте целостность упаковки. Если она повреждена, требуйте составления акта расхождения сразу на месте — это необходимо для решения возможных проблем с недостачей или повреждением товара.
				...
				<div class="tab">
					<div class="container">
						...
						<ul class="del_items">
							<li> <span class="icon"> <img width="56" alt="Заказать доставку" src="/bitrix/templates/main/images/city_del_ico_1.jpg" heigh="56"> </span> <span class="text">Заказать доставку</span> </li>
							<li> <span class="icon"> <img width="56" src="/bitrix/templates/main/images/city_del_ico_2.jpg" heigh="56" alt="Самовывоз"> </span> <span class="text">Самовывоз</span> </li>
						</ul>
						<div class="clear">
						</div>
						<p>
							 Кованые изделия не только имеют красивый внешний вид, но и внушительную массу. Лёгкое и невесомое на первый взгляд кружево из стальных прутов иногда сложно даже просто поднять и выгрузить. Вот почему задача транспортировки порой становится головной болью для покупателя. В магазине вы можете заказать кованые изделия, воспользовавшись не только самовывозом. Чтобы облегчить эту трудную задачу, мы предоставляем услугу доставки по городу, области и по всей России. Ознакомиться со способами, тарифами и транспортом вы можете в разделах сайта.
						</p>
						<ul class="common">
							<li>По городу осуществляется грузоперевозка предметов, весом не более тонны, размером до 4м, объёмом максимум 12 кубометров. Стоимость доставки изделий больших габаритов обсуждается отдельно.</li>
							<li>Грузы по городу и пригороду (в районе 15км) доставляются за 1-2 рабочих дня с момента оформления. Существует также срочная перевозка, которую нужно обсуждать с менеджером.</li>
 <br>
						</ul>
						<p>
 <span class="red">ВНИМАНИЕ!</span> Время на самостоятельную разгрузку клиентом машины с товаром включено в сумму оплаты доставки и не должно превышать 30 минут. Превышение времени подлежит дополнительной оплате, которая рассчитывается по текущей цене на время простоя грузового транспорта.
						</p>
						...
						<div class="tarif_items">
							<div class="item">
								<div class="image">
 <img width="190" src="/bitrix/templates/main/images/del_photo_1.jpg" height="190" alt="ГАЗЕЛЬ">
								</div>
								<div class="text">
 <span class="in"> <span class="name">ГАЗЕЛЬ</span> </span>
								</div>
							</div>
							<div class="item">
								<div class="image">
 <img width="190" src="/bitrix/templates/main/images/del_photo_2.jpg" height="190" alt="ГАЗЕЛЬ">
								</div>
								<div class="text">
 <span class="in"> <span class="name">ЗУБР</span> </span>
								</div>
							</div>
							<div class="item">
								<div class="image">
 <img width="190" src="/bitrix/templates/main/images/del_photo_3.jpg" height="190" alt="ГАЗЕЛЬ">
								</div>
								<div class="text">
 <span class="in"> <span class="name">МАЗ</span> </span>
								</div>
							</div>
							<div class="clear">
							</div>
 ...
 <br>
							<p>
								 При наличии претензии, товар можно вернуть или обменять, согласно статье №520 ГК РФ и статье №25 «Закона о защите прав потребителя». Для этого потребуется паспорт и товарный или кассовый чек на изделие.
							</p>
						</div>
					</div>
				</div>
				<div class="tab">
					<div class="container">
						<p>
							 По области кованые изделия перевозятся также за 1-2 рабочих дня с момента оформления заказа. <br>
