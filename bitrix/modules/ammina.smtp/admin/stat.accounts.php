...
$sTableID = "tbl_ammina_smtp_stat_accounts";
global $by, $order;
...
$rsItems = \Ammina\SMTP\StatAccountsTable::getList(array(
	"order" => $arOrder,
	"filter" => $arFilter,
	"runtime" => $runtime,
...
while ($arData = $rsItems->NavNext(true, "f_")) {
	...
	$row->AddViewField("ACCOUNT_ID", '[<a href="/bitrix/admin/ammina.smtp.accounts.edit.php?ID=' . $arData['ACCOUNT_ID'] . '">' . $arData['ACCOUNT_ID'] . '</a>] ' . $arData['ACCOUNT_AREA_EMAIL']);
}
