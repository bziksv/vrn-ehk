    ...
    <tr>
        <td colspan="2" align="center">
            <div class="adm-info-message-wrap" align="left">
                <div class="adm-info-message"><?=GetMessage('WBS24.OZONEXPORT.MANUAL_CALL_NOTE');?></div>
            </div>
        </td>
    </tr>
<?endif;?>
...
<tr>
    <td width="40%"><? echo GetMessage('BX_CATALOG_EXPORT_YANDEX_OPTION_CONVERT_TO_CP1251'); ?></td>
    <td width="60%">
        <input type="hidden" name="EXPORT_CHARSET" value="UTF-8">
        <input type="checkbox" name="EXPORT_CHARSET" value="windows-1251"<?=($exportCharset == 'windows-1251' ? ' checked' : ''); ?>>
    </td>
</tr>
<?
...
<tr>
	...
	<td width="60%">
        ...
        <input id="openLinkToFeed" type="button" value="<?=GetMessage("WBS24.OZONEXPORT.OPEN_LINK");?>">
        <input id="copyLinkToFeed" type="button" value="<?=GetMessage("WBS24.OZONEXPORT.COPY_LINK");?>">
        <span id="copyLinkToFeedSuccess" style="display: none;"><?=GetMessage("WBS24.OZONEXPORT.COPY_LINK_SUCCESS");?></span>
	</td>
</tr>
<script>
...
$ozonFormula = new Wbs24\Ozonexport\Formula();
?>
<tr class="heading tr-ep-formula">
    <td colspan="2"><?=GetMessage('WBS24_OZONEXPORT_FORMULA_SUBTITLE');?></td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%"><?=GetMessage('WBS24_OZONEXPORT_FORMULA_ON');?></td>
    <td width="60%">
...
<tr class="tr-ep-formula">
    <td width="40%"><?=GetMessage('WBS24_OZONEXPORT_FORMULA_PRICE');?></td>
    <td width="60%">
        <input type="text" class="ozonexport-formula" data-type="price" name="BLOB[formulaPrice]" size="50" value="<?=$ozonFormula->cleanFormula($blob['formulaPrice']);?>">
    </td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%">
    ...
    <td width="60%">
        <?=$ozonAdmin->getFormulaMarks('price', [
            'PRICE',
        ]);?>
    </td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%"><?=GetMessage('WBS24_OZONEXPORT_FORMULA_OLDPRICE');?></td>
    <td width="60%"></td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%"><?=GetMessage('WBS24_OZONEXPORT_FORMULA_OLDPRICE_BEFORE_10K');?></td>
    <td width="60%">
        <?php
        $ozonFormula->setMarks([
            'PRICE',
            'PRICE_DISCOUNT',
        ]);
        ?>
        <input type="text" class="ozonexport-formula" data-type="oldprice" name="BLOB[formulaOldPrice]" size="50" value="<?=$ozonFormula->cleanFormula($blob['formulaOldPrice']);?>">
    </td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%" style="padding-top: 0;">&nbsp;</td>
    <td width="60%" style="padding-top: 0;"><small><?=GetMessage("WBS24_OZONEXPORT_FORMULA_OLDPRICE_BEFORE_10K_NOTE");?></small></td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%">
    </td>
    <td width="60%">
        <?=$ozonAdmin->getFormulaMarks('oldprice', [
            'PRICE',
            'PRICE_DISCOUNT',
        ]);?>
    </td>
...
<tr class="tr-ep-formula">
    <td width="40%"><?=GetMessage('WBS24_OZONEXPORT_FORMULA_OLDPRICE_AFTER_10K');?></td>
    <td width="60%">
        <input type="text" class="ozonexport-formula" data-type="oldprice_10k" name="BLOB[formulaOldPrice10k]" size="50" value="<?=$ozonFormula->cleanFormula($blob['formulaOldPrice10k']);?>">
    </td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%" style="padding-top: 0;">&nbsp;</td>
    <td width="60%" style="padding-top: 0;"><small><?=GetMessage("WBS24_OZONEXPORT_FORMULA_OLDPRICE_AFTER_10K_NOTE");?></small></td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%">
    </td>
    <td width="60%">
        <?=$ozonAdmin->getFormulaMarks('oldprice_10k', [
            'PRICE',
            'PRICE_DISCOUNT',
        ]);?>
    </td>
...
<tr class="tr-ep-formula">
    <td width="40%"><?=GetMessage('WBS24_OZONEXPORT_FORMULA_MIN_PRICE');?></td>
    <td width="60%">
        <input type="text" class="ozonexport-formula" data-type="min_price" name="BLOB[formulaMinPrice]" size="50" value="<?=$ozonFormula->cleanFormula($blob['formulaMinPrice']);?>">
    </td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%">
    ...
    <td width="60%">
        <?=$ozonAdmin->getFormulaMarks('min_price', [
            'PRICE',
            'PRICE_DISCOUNT',
        ]);?>
    </td>
...
<tr class="tr-ep-formula">
    <td width="40%"><?=GetMessage('WBS24_OZONEXPORT_FORMULA_PREMIUM_PRICE');?></td>
    <td width="60%">
        <input type="text" class="ozonexport-formula" data-type="premium_price" name="BLOB[formulaPremiumPrice]" size="50" value="<?=$ozonFormula->cleanFormula($blob['formulaPremiumPrice']);?>">
    </td>
</tr>
<tr class="tr-ep-formula">
    <td width="40%">
    ...
    <td width="60%">
        <?=$ozonAdmin->getFormulaMarks('premium_price', [
            'PRICE',
            'PRICE_DISCOUNT',
        ]);?>
    </td>
...
<tr class="tr-ep-formula">
	<td width="40%" style="padding-top: 0;">&nbsp;</td>
	<td width="60%" style="padding-top: 0;"><small><?=GetMessage("WBS24_OZONEXPORT_FORMULA_NOTE");?></small></td>
</tr>
</section>
<script src='/bitrix/js/wbs24.ozonexport/formula.js?<?=time()?>'></script>
<script>{let formula = new Wbs24OzonexportFormula()}</script>
<style>
.ozonexport-mark {margin: 0 10px 0 0; text-decoration: none; border-bottom: 1px dashed blue; padding-bottom: 1px;}
.ozonexport-mark:hover {text-decoration: none; border-bottom: 1px solid blue;}
</style>
...
?>
<tr class="heading">
	<td colspan="2"><?=GetMessage('BX_CATALOG_EXPORT_WAREHOUSE_LABEL');?></td>
</tr>
<tr>
...
<tr class="heading">
	<td colspan="2"><?=GetMessage('BX_CATALOG_EXPORT_WAREHOUSE_EXTEND_LABEL');?></td>
</tr>
<tr>
...
<tr>
    <td width="40%"><?=GetMessage('BX_CATALOG_EXPORT_WAREHOUSE_SUM_ON');?></td>
    <td width="60%">
        <input type="hidden" name="BLOB[warehouseSumOn]" value="N">
        <input type="checkbox"
            class="warehouse_sum__settings"
            name="BLOB[warehouseSumOn]"
            value="Y"
            <?=($blob['warehouseSumOn'] == 'Y' ? ' checked' : '');?>
        >
        <?=GetMessage("BX_CATALOG_EXPORT_WAREHOUSE_SUM_NAME");?>
        <input type="text"
            class="warehouse_sum__settings"
            name="BLOB[warehouseSumName]"
            size="45"
            value="<?=$blob['warehouseSumName'];?>"
        >
    </td>
</tr>
<tr>
...
<tr class="heading">
    <td colspan="2"><?=GetMessage('WBS24.OZONEXPORT.WAREHOUSE_PROPBASED_SUBTITLE');?></td>
</tr>
<tr>
    <td width="40%"><?=GetMessage('WBS24.OZONEXPORT.WAREHOUSE_PROPBASED_ON');?></td>
    <td width="60%">
...
<?for($i = 1; $i <= 5; $i++):?>
    <tr class="propbased_warehouse_elements">
        <td width="40%"><?=GetMessage('WBS24.OZONEXPORT.WAREHOUSE_PROPBASED_PROP').' '.$i.':';?></td>
        <td width="60%">
            <?=$ozonAdmin->getSelectProperties($IBLOCK_ID, 'BLOB[stocksProp'.$i.']', $blob['stocksProp'.$i]);?>
        </td>
    </tr>
    <tr class="propbased_warehouse_elements">
        <td width="40%"><?=GetMessage('WBS24.OZONEXPORT.WAREHOUSE_PROPBASED_STORE_TITLE').' '.$i.':';?></td>
        <td width="60%">
            <input
                type="text"
                name="BLOB[stocksPropName<?=$i;?>]"
                value="<?=$blob['stocksPropName'.$i];?>"
                size="45"
            >
        </td>
    </tr>
...
<tr>
    <td colspan="2">
        <div class="adm-info-message">
            <span><?=GetMessage("WBS24.OZONEXPORT.WAREHOUSE_PROPBASED_WARNING");?></span>
        </div>
    </td>
</tr>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        let showWarehouseDefaultName = function () {
            let show = !extendWarehouse.checked && !propbasedWarehouse.checked;
            warehouseDefaultName.disabled = !show;
        }

        let showExtendedWarehouse = function () {
            let show = !propbasedWarehouse.checked;
            extendWarehouse.disabled = !show;
        }

        let showExtendedWarehouseSettings = function () {
            let show = extendWarehouse.checked;
            extendWarehouseFilter.disabled = !show;
            for (let elem of document.querySelectorAll('.warehouse_sum__settings')) {
                elem.disabled = !show;
            }
        }

        let showExtendedWarehouseList = function () {
            let show = extendWarehouse.checked && extendWarehouseFilter.checked;
        ...
        let showPropbasedWarehouse = function () {
            let show = !extendWarehouse.checked;
            propbasedWarehouse.disabled = !show;
        }

        let showPropbasedWarehouseList = function () {
            let show = propbasedWarehouse.checked;
            let settings = document.querySelectorAll(
                '.propbased_warehouse_elements input, .propbased_warehouse_elements select'
            );
            for (let elem of settings) {
                elem.disabled = !show;
            }
        ...
        let verifyShowAll = function () {
            showWarehouseDefaultName();

            showExtendedWarehouse();
            showExtendedWarehouseSettings();
            showExtendedWarehouseList();

            showPropbasedWarehouse();
            showPropbasedWarehouseList();
        }
