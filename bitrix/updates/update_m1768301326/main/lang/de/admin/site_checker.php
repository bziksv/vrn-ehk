...
$MESS["MAIN_SC_TEST_FAST_FILES_MSGVER_1"] = "Bitrix24 Drive. Schnelle Dateiverwaltung";
...
$MESS["PHP_VER_NOTIFY"] = "Achtung! Sie erhalten keine System- oder Sicherheits-Updates, weil Ihre PHP-Version #CUR# veraltet ist. Bitte aktualisieren Sie Ihr PHP auf die Version #REQ#. Bitte lesen Sie diese <a href=\"https://helpdesk.bitrix24.com/open/17347208/\">Helpdesk-Seite</a>, bevor Sie PHP aktualisieren würden.";
...
$MESS["SC_DATABASE_LC_CTYPE"] = "Sortierung in der Datenbank (#VAL0#) ist nicht UTF-8. Einige Funktionen werden nicht korrekt funktionieren. Um den Fehler zu beheben, exportieren Sie die Datenbank, erstellen Sie eine neue per Ausführung von \"CREATE DATABASE newDB lc_ctype='C.UTF-8' template template0\", und dann importieren Sie die exportierten Daten zurück. Anschließend ändern Sie die website-Parameter, um die neue Datenbank zu nutzen.";
$MESS["SC_DB_CHARSET"] = "Zeichenkodierung der Datenbank";
$MESS["SC_DB_ERR"] = "Fehler bei der Datenbankversion:";
$MESS["SC_DB_ERR_DEFAULT_STORAGE_ENGINE"] = "default_storage_engine=#VALUE#, InnoDB ist erforderlich";
$MESS["SC_DB_ERR_INNODB_DEFAULT_ROW_FORMAT"] = "innodb_default_row_format=#VALUE#, DYNAMIC ist erforderlich";
$MESS["SC_DB_ERR_INNODB_LARGE_PREFIX"] = "innodb_large_prefix=#VALUE#, ON ist erforderlich";
...
Der Instant Messenger erfordert, dass der Leseport von Nginx's push-stream-module verbunden werden kann. Die Portnummer kann in den Einstellungen des Moduls <a href=\"https://www.bitrixsoft.com/support/training/course/index.php?COURSE_ID=26&LESSON_ID=5144\">Push and Pull</a> gefunden werden.
";
$MESS["SC_HELP_CHECK_AD"] = "Wenn in Ihrem lokalen Netzwerk ein Windows AD- oder LDAP-Server eingestellt ist, sollte überprüft werden, ob AD <a href=\"https://www.bitrixsoft.com/support/training/course/index.php?COURSE_ID=20&CHAPTER_ID=04264\">korrekt konfiguriert ist</a>.
...
";
$MESS["SC_HELP_CHECK_EXTRANET"] = "Damit das Modul <a href=\"https://www.bitrixsoft.com/products/intranet/features/collaboration/extranet.php\">Extranet</a> funktioniert, muss Ihr Intranet von außen via Internet erreichbar sein.
...
In den Einstellungen vom <a href=\"/bitrix/admin/settings.php?mid=main\">Hauptmodul</a> muss eine entsprechende Option aktiviert werden. Die <a href=\"https://www.bitrix.de/products/virtual_appliance/\">Bitrix Virtual Appliance</a> unterstützt diese Option standardmäßig.
";
...
";
$MESS["SC_HELP_CHECK_MYSQL_TABLE_FORMAT"] = "Das System hat folgende Anforderungen seitens der datenbank:

1. Speicher-Engine InnoDB für maximale Zuverlässigkeit und Unterstützung von Transaktionen.
2. Zeilenformat darf nicht REDUNDANT oder COMPACT sein, weil das die Indexieren in der Codierung UTF-8 aufgrund der Limits für Zeilenlänge verhindern kann.";
...
Einstellung von NTLM auf Linux ist keine einfache Aufgabe, aber die <a href=\"https://www.bitrixsoft.com/products/virtual_appliance/\">Bitrix Virtual Appliance</a> ab Version 4.2. enthält auch diese Funktion und sie muss lediglich aktiviert werden.
";
...
";
$MESS["SC_HELP_CHECK_PERF"] = "Hier wird die Server-Performance mithilfe des <a href=\"https://www.bitrixsoft.com/support/training/course/index.php?COURSE_ID=20&CHAPTER_ID=04955\">Performance-Monitors</a> geprüft.
...
Die <a href=\"https://www.bitrix.de/products/virtual_appliance/\">Bitrix Virtual Appliance</a> wird mit ca. 30 Einheiten bewertet.
...
";
$MESS["SC_HELP_CHECK_PGSQL_CONNECTION_CHARSET"] = "Die Codierung der PostgreSQL-Verbindung muss UTF-8 sein.";
$MESS["SC_HELP_CHECK_PGSQL_DB_CHARSET"] = "PostgreSQL locale mzss UTF-8 sein.";
$MESS["SC_HELP_CHECK_PGSQL_VERSION"] = "Die Version des PostgreSQL-Servers muss den Mindestanforderungen entsprechen.";
...
$MESS["SC_HELP_CHECK_PULL_COMMENTS"] = "Damit die Kommentare im Activity Stream gleich für alle Leser verfügbar werden, muss das Modul Push and Pull zusätzlich konfiguriert werden. Dafür muss auf Ihrem Nginx-Server das Modul push-stream-module installiert, und dann in den Moduleinstellungen des Moduls <a href=\"https://www.bitrixsoft.com/support/training/course/index.php?COURSE_ID=26&LESSON_ID=5144\">Push and Pull</a> aktiviert werden.

Die <a href=\"https://www.bitrixsoft.com/products/virtual_appliance/index.php\">Bitrix Virtual Appliance</a> unterstützt diese Funktion ab Version 4.2.
";
$MESS["SC_HELP_CHECK_PULL_STREAM"] = "Die Unterstützung seitens des Servers ist erforderlich für eine korrekte Arbeitsweise des Moduls <a href=\"https://www.bitrixsoft.com/support/training/course/index.php?COURSE_ID=26&LESSON_ID=5144\">Push and Pull</a>.
...
Die <a href=\"https://www.bitrix.de/products/virtual_appliance /\">Bitrix Virtual Appliance</a> ab Version 4.2 unterstützt dieses Modul im vollen Umfang.
";
$MESS["SC_HELP_CHECK_PUSH_BITRIX"] = "Das Modul <a href=\"https://www.bitrixsoft.com/support/training/course/index.php?COURSE_ID=26&LESSON_ID=5144\">Push and Pull</a> ermöglicht eine Sofortübertragung von Nachrichten mit der Technologie Pull und das Senden von Benachrichtigungen an mobile Geräte mit der Technologie Push via <a href=\"https://www.bitrix.de/products/intranet/features/bitrixmobile.php\">Bitrix Mobile App</a>.";
...
Die <a href=\"https://www.1c-bitrix.ru/products/vmbitrix/index.php\">Bitrix Virtual Appliance</a> unterstützt das standardmäßig.
";
...
Außerdem kann auch auf der Client-Seite eine zusätzliche Konfiguration <a href=\"https://www.bitrixsoft.com/support/training/course/index.php?COURSE_ID=27&LESSON_ID=1466#office\">erforderlich sein</a>, um direkte Bearbeitung zu unterstützen, und es besteht keine Möglichkeit, diese Konfiguration per Fernzugriff zu prüfen.
";
...
$MESS["SC_PGSQL_ERR_VER"] = "Aktuelle PostgreSQL-Version: #CUR#, erforderlich: #REQ#.";
...
$MESS["SC_TABLE_ROW_FORMAT"] = "&quot;#TABLE#&quot; Format ist nicht InnoDB, oder Zeilenformat ist jetzt Dynamic.";
$MESS["SC_TABLE_ROW_FORMAT_ERRORS"] = "Nicht alle InnoDB Tabellen sind im Format Dynamic. Fehler gesamt: #VAL#, #VAL1# von denen können automatisch behoben werden.";
$MESS["SC_TABLE_ROW_FORMAT_NA"] = "Nicht geprüft wegen Fehler des Tabellenspeicherformats.";
...
$MESS["SC_T_FORMAT"] = "Format der Datenbanktabellen";
...
$MESS["SC_T_PGSQL_VER"] = "Version des PostgreSQL-Servers";
