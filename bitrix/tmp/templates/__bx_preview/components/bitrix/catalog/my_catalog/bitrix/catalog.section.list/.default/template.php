...
<div class="selector_block">
	<div class="selector_content">
		...
		<div class="clear"></div>
			...
			<ul class="menu_type">
				<?
				if ($arResult["SECTION"]["DEPTH_LEVEL"] === 0 && $dir === '/catalog/'): ?>
					<?
						$APPLICATION->IncludeFile(SITE_TEMPLATE_PATH . "/includes/additional_section_content.php", Array(), Array(
							"SHOW_BORDER" => false
						));
					?>
				<? else: ?>
